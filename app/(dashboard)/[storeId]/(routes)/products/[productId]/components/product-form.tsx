...
import { Category, VehicleBrand, VehicleType, ProductBrand, Image, Product } from "@prisma/client"
                  ...
                  <Select disabled={loading} onValueChange={field.onChange} value={field.value} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      {vehicleBrands.map((vehicleBrand) => (
                        <SelectItem key={vehicleBrand.id} value={vehicleBrand.id}>{vehicleBrand.name}</SelectItem>
                      ))}
                    </SelectContent>
                  </Select>
                  <FormMessage />
                  ...
                  <Select disabled={loading} onValueChange={field.onChange} value={field.value} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      {productBrands.map((productBrand) => (
                        <SelectItem key={productBrand.id} value={productBrand.id}>{productBrand.name}</SelectItem>
                      ))}
                    </SelectContent>
                  </Select>
                  <FormMessage />
